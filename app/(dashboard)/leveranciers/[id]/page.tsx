...
import { Button, Input, Label, Textarea, Card, CardContent, CardHeader, CardTitle, PageLoader } from '@/components/ui'
import { createClient } from '@/lib/supabase/client'
import { toast } from 'sonner'
import { Trash2 } from 'lucide-react'

export default function LeverancierDetailPage() {
  ...
  return (
    <div>
      <PageHeader
        title={formData.name || 'Leverancier'}
        description="Leverancier bewerken"
        breadcrumbs={[
          { label: 'Dashboard', href: '/' },
          { label: 'Leveranciers', href: '/leveranciers' },
          { label: formData.name || 'Detail' },
        ]}
        actions={
